...
<body>
	...
	<div class="container-fluid" id="part2">
		...
		<section id="part2left">
			...
			<form action="<?php echo base_url();?>index.php/necklace3_controller/check_data/" method="post" class="col-lg-5 nazar">
			...
			<input type="hidden" name="code" value="<a href='<?php echo base_url()?>index.php/necklace3_cntroller/necklace3/'> 1076 </a>">
			<input type="hidden" name="img" value="<img src='<?php echo base_url();?>img/necklace3.jpg' width='50' />">
