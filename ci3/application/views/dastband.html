...
<title>دستبند</title>
	...
	<link rel="stylesheet" href="css/style_gardanband.css">
...
<body data-spy="scroll" data-target="#menu1" >
	...
	<div class="container-fluid" id="part1">
		...
		<h4 class="h4"><a href="index.html" class="h4a">  جواهری</a>  )) محصولات  ))   دستبند  </h4>
	</div>
	...
	<div class="container-fluid" id ="part2">
		...
		<a href="dastband1.html"  target="_blank"  ><img src ="img/dastband1.jpg" alt="دستبند" class="part2img"></a>
		<a href="dastband2.html"  target="_blank"  ><img src ="img/dastband2.jpg" alt="دستبند" class="part2img"></a>
		<a href="dastband3.html"  target="_blank"  ><img src ="img/dastband3.jpg" alt="دستبند" class="part2img"></a>
		<a href="dastband4.html"  target="_blank"  ><img src ="img/dastband4.jpg" alt="دستبند" class="part2img"></a>
		<a href="dastband5.html"  target="_blank"  ><img src ="img/dastband5.jpg" alt="دستبند" class="part2img"></a>
		<a href="dastband6.html"  target="_blank"  ><img src ="img/dastband6.jpg" alt="دستبند" class="part2img"></a>
	</div>
