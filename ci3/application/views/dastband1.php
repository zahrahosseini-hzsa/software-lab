...
<body>
	...
	<div class="container-fluid" id="part2">
		<section id="part2right">
			...
			<h4 class="part2h4">کد محصول:1168</h4>
			<p class="part2p">Bracelet</p>
		...
		<section id="part2left">
			<img src="<?php echo base_url();?>img/dastband1.jpg" data-zoom-image="<?php echo base_url();?>img/dastband1.jpg" alt="pic" class="zoom z_img img-size">
		</section>
		...
		<form action="<?php echo base_url();?>index.php/dastband1_controller/check_data/" method="post" class="col-lg-5 nazar">
            ...
            value="<a href='http://localhost:81/ci3/index.php/dastband1_controller/dastband1/'> 1168 </a>" > 
