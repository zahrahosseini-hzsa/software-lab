...
گردنبند فیروزه اشک
			...
			<h4 class="part2h4">کد محصول:1075</h4>
		...
		<section id="part2left">
			<img src="<?php echo base_url();?>/img/gardanband3.jpg" data-zoom-image="<?php echo base_url();?>/img/gardanband3.jpg" alt="pic" class="zoom z_img img-size">
		</section>
		
	<form action="<?php echo base_url();?>index.php/gardanband3_controller/check_data/" method="post" class="col-lg-5 nazar">
            ...
            value="<a href='<?php echo base_url()?>index.php/gardanband3_controller/gardanband3/'> 1075 </a>" > 
