...
<title>دستبند</title>
	...
	<link rel="stylesheet" href="<?php echo base_url();?>css/style_gardanband.css">
...
<body data-spy="scroll" data-target="#menu1" >
	...
	<div class="container-fluid" id="part1">
		...
		<h4 class="h4"><a href="index.php/index_controller/index/" class="h4a">  جواهری</a>  )) محصولات  ))   دستبند  </h4>
	</div>
	...
	<div class="container-fluid" id ="part2">
		...
		<a href="<?php echo base_url();?>index.php/dastband4_controller/dastband4/"  target="_blank"  ><img src ="<?php echo base_url();?>img/dastband4.jpg" alt="دستبند" class="part2img"></a>
