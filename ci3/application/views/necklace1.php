...
<body>
	...
	<div class="container-fluid" id="part2">
		<section id="part2right">
			...
			<h3 class="part2h3">آویز پر</h3>
			<h4 class="part2h4">کد محصول:1088</h4>
			<p class="part2p">Pendant</p>
		...
		<form action="<?php echo base_url();?>index.php/dastband1_controller/check_data/" method="post" class="col-lg-5 nazar">
            ...
            value="<a href='http://localhost:81/ci3/index.php/necklace1_controller/necklace1/'> 1168 </a>" > 
            <input type="hidden" name="img" value="<img src='http://localhost:81/ci3/img/necklace1.jpg' width='150'/>"> 
			<input type="submit"   class="button" value="ثبت نظر ">
		</form>
		<form action="<?php echo base_url();?>index.php/necklace1_controller/sefaresh/" method="post" id="form_sefaresh">
				<input type="text" class="sefaresh" name="code" value="<a href='http://localhost:81/ci3/index.php/necklace1_controller/necklace1'>1088</a>">
				<input type="text" class="sefaresh" name="price" value="1 میلیون">
				<input type="text" class="sefaresh" name="img" value="<img src='http://localhost:81/ci3/img/necklace1.jpg'">
