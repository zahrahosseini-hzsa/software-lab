...
<body>
	...
	<div class="container-fluid justify-content-center" id="part2">
		...
		<form action="<?php echo base_url();?>index.php/ring1_controller/check_data/" method="post" class="col-lg-5 nazar">
			...
			<input type="hidden" name="code" value="<a href='<?php echo base_url()?>index.php/ring1_cntroller/ring1/'> 1175 </a>">
			<input type="hidden" name="img" value="<img src='<?php echo base_url();?>img/ring1.jpg' width='50' />">
