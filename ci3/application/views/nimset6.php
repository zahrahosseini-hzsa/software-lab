...
سرویس برلیان</h3>
		...
		<form action="<?php echo base_url();?>index.php/nimset6_controller/check_data/" method="post" class="col-lg-5 nazar">
			...
			<input type="hidden" name="code" value="<a href='<?php echo base_url()?>index.php/nimset6_cntroller/nimset6/'> 1082 </a>">
			<input type="hidden" name="img" value="<img src='<?php echo base_url();?>img/nimset6.jpg' width='50' />">
