...
<body>
	...
	<div class="container-fluid" id="part2">
		<section id="part2right">
			...
			<h3 class="part2h3">
سرویس برلیان</h3>
			<h4 class="part2h4">کد محصول:1082</h4>
			<p class="part2p"> Diamond Set</p>
			<p class="part2p">N: 6553</p>
			<p class="part2p">Ds:0.64 ct</p>
			<input type="button"   class="button" value="سفارش محصول ">
		
		</section>
		<section id="part2left">
			<img src="<?php echo base_url();?>/img/nimset6.jpg" data-zoom-image="<?php echo base_url();?>/img/nimset6.jpg" alt="pic" class="zoom z_img ">
		</section>
		
		<form action="<?php echo base_url();?>index.php/nimset6_controller/check_data/" method="post" class="col-lg-5 nazar">
            ...
            value="<a href='http://localhost:81/ci3/index.php/nimset6_controller/nimset6/'> 1082 </a>" > 
            <input type="hidden" name="img" value="<img src='http://localhost:81/ci3/img/nimset6.jpg' width='150'/>">
			<input type="submit"   class="button" value="ثبت نظر ">
		</form>
		<form action="<?php echo base_url();?>index.php/nimset6_controller/sefaresh/" method="post" id="form_sefaresh">
				<input type="text" class="sefaresh" name="code" value="<a href='http://localhost:81/ci3/index.php/nimset6_controller/nimset6'>1082</a>">
				<input type="text" class="sefaresh" name="price" value="1 میلیون">
				<input type="text" class="sefaresh" name="img" value="<img src='http://localhost:81/ci3/img/nimset6.jpg'">
