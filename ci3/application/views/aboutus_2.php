...
<title>جواهری عطایی به قلم تاریخ</title>
	...
	<link rel="stylesheet" href="css/style_aboutus_2.css">
...
<body data-spy="scroll" data-target="#menu1">
	...
	<div class="container-fluid part1">
		<section id="sec1">
			<h3 class="h3sec1">جواهری عطایی به قلم تاریخ</h3>
		...
		<section id="sec2">
			<article id="article">
				<div id="gallary">
            	<img src="img/d1.jpg" alt="1"/>
            	<img src="img/d2.jpg" alt="2"/>
            	<img src="img/d3.jpg" alt="3"/>
            	<img src="img/d4.jpg" alt="4"/>
            	<img src="img/d5.jpg" alt="5"/>
