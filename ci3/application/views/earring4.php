...
<body>
	...
	<div class="container-fluid" id="part2">
		<section id="part2right">
			...
			<h3 class="part2h3">گوشواره مارکیز گرده و اشک برلیان</h3>
			<h4 class="part2h4">کد محصول:1131</h4>
			<p class="part2p">Diamond-Earing</p>
			<p class="part2p">N:6666</p>
			<p class="part2p">Ds:0.64 ct</p>
			
		</section>
		<section id="part2left">
			<img src="<?php echo base_url();?>img/earings4.jpg" data-zoom-image="<?php echo base_url();?>img/earings4.jpg" alt="pic" class="zoom z_img img-size">
		</section>
		
		<form action="<?php echo base_url();?>index.php/earring4_controller/check_data/" method="post" class="col-lg-5 nazar">
		...
		<form action="<?php echo base_url();?>index.php/earring4_controller/sefaresh/" method="post" id="form_sefaresh">
				<input type="text" class="sefaresh" name="code" value="<a href='http://localhost:81/ci3/index.php/earring4_controller/earring4'>1131</a>">
				<input type="text" class="sefaresh" name="price" value="1 میلیون">
				<input type="text" class="sefaresh" name="img" value="<img src='http://localhost:81/ci3/img/earring4.jpg'">
