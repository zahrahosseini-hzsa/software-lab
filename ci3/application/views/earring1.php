...
<body>
	...
	<div class="container-fluid" id="part2">
		<section id="part2right">
			...
			<h3 class="part2h3">گوشواره مروارید و برلیان</h3>
			<h4 class="part2h4">کد محصول:1955</h4>
			<p class="part2p">Pearl-Diamond</p>
			<p class="part2p">N:6759</p>
			<p class="part2p">Ds:0.64 ct</p>
			
		</section>
		<section id="part2left">
			<img src="<?php echo base_url();?>img/earings1.jpg" data-zoom-image="<?php echo base_url();?>img/earings1.jpg" alt="pic" class="zoom z_img img-size">
		</section>
		
		<form action="<?php echo base_url();?>index.php/earring1_controller/check_data/" method="post" class="col-lg-5 nazar">
            ...
            value="<a href='<?php echo base_url()?>index.php/earring1_controller/earring1/'> 1955 </a>" > 
            <input type="hidden" name="img" value="<img  src='<?php echo base_url();?>img/earring1.jpg' width='150' />">
			<input type="submit"   class="button" value="ثبت نظر ">
		</form>
		<form action="<?php echo base_url();?>index.php/earring1_controller/sefaresh/" method="post" id="form_sefaresh">
				<input type="text" class="sefaresh" name="code" value="<a href='http://localhost:81/ci3/index.php/earring1_controller/earring1'>1955</a>">
				<input type="text" class="sefaresh" name="price" value="1 میلیون">
				<input type="text" class="sefaresh" name="img" value="<img src='http://localhost:81/ci3/img/earring1.jpg'">
