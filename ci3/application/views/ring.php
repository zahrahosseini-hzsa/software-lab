...
<title>انگشتر</title>
	...
	<link rel="stylesheet" href="<?php echo base_url();?>css/style_angoshtar.css">
...
<body data-spy="scroll" data-target="#menu1" >
	...
	<div class="container-fluid" id="part1">
		<h3 class="h3">انگشتر</h3>
		<h4 class="h4"><a class="h4a">  جواهری </a>  )) محصولات  ))   انگشتر  </h4>
	</div>
	
	
	
	<div class="container-fluid" id ="part2">
		<h2 class="h2title">انگشتر</h2>
		<img src="<?php echo base_url();?>img/hr.png" alt="hr" class="hr"><br/>
		
		<a href="<?php echo base_url();?>index.php/ring1_controller/ring1/" target="_blank" ><img src ="<?php echo base_url();?>img/ring1.jpg" alt="انگشتر" class="part2img"></a>
		<a href="<?php echo base_url();?>index.php/ring2_controller/ring2/" target="_blank" ><img src ="<?php echo base_url();?>img/ring2.jpg" alt="انگشتر" class="part2img"></a>
		<a href="<?php echo base_url();?>index.php/ring3_controller/ring3/"  target="_blank" ><img src ="<?php echo base_url();?>img/ring3.jpg" alt="انگشتر" class="part2img"></a>
		<a href="<?php echo base_url();?>index.php/ring4_controller/ring4/" target="_blank"  ><img src ="<?php echo base_url();?>img/ring4.jpg" alt="انگشتر" class="part2img"></a>
		<a href="<?php echo base_url();?>index.php/ring5_controller/ring5/" target="_blank"  ><img src ="<?php echo base_url();?>img/ring5.jpg" alt="انگشتر" class="part2img"></a>
		<a href="<?php echo base_url();?>index.php/ring6_controller/ring6/"  target="_blank" ><img src ="<?php echo base_url();?>img/ring6.jpg" alt="انگشتر" class="part2img"></a>
	</div>
