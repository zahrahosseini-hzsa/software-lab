...
<body>
	...
	<div class="container-fluid" id="part2">
		<section id="part2right">
			...
			<h3 class="part2h3">دستبند عقیق</h3>
			<h4 class="part2h4">کد محصول:1137</h4>
		...
		<section id="part2left">
			<img src="<?php echo base_url();?>img/dastband2.jpg" data-zoom-image="<?php echo base_url();?>img/dastband2.jpg" alt="pic" class="zoom z_img img-size">
		</section>
		
		<form action="<?php echo base_url();?>index.php/dastband2_controller/check_data/" method="post" class="col-lg-5 nazar">
            ...
            value="<a href='<?php echo base_url()?>index.php/dastband2_controller/dastband2/'> 1137 </a>" > 
		...
		<form action="<?php echo base_url();?>index.php/dastband2_controller/sefaresh/" method="post" id="form_sefaresh">
				<input type="text" class="sefaresh" name="code" value="<a href='http://localhost:81/ci3/index.php/dastband2_controller/dastband2'>1137</a>">
