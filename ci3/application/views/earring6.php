...
<body>
	...
	<div class="container-fluid" id="part2">
		...
		<section id="part2left">
			...
			<form action="<?php echo base_url();?>index.php/earring6_controller/check_data/" method="post" class="col-lg-5 nazar">
            ...
            value="<a href='<?php echo base_url()?>index.php/earring6_controller/earring6/'> 1002 </a>" > 
