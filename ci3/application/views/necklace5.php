...
<body>
	...
	<div class="container-fluid" id="part2">
		...
		<section id="part2left">
			...
			<form action="<?php echo base_url();?>index.php/necklace5_controller/check_data/" method="post" class="col-lg-5 nazar">
			...
			<input type="hidden" name="code" value="<a href='<?php echo base_url()?>index.php/necklace5_cntroller/necklace5/'> 1133 </a>">
			<input type="hidden" name="img" value="<img src='<?php echo base_url();?>img/necklace5.jpg' width='50' />">
