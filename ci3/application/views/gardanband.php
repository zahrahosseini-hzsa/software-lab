...
<body data-spy="scroll" data-target="#menu1">
	...
	<div class="container-fluid" id="part1">
		<h3 class="h3">گردنبند</h3>
		<h4 class="h4"><a href="<?php echo base_url();?>index.php/index_controller/index/" class="h4a">  جواهری </a>  )) محصولات  ))   گردنبند  </h4>
	</div>
	
	
	
	<div class="container-fluid" id ="part2">
		<h2 class="h2title">گردنبند</h2>
		...
		<a href="<?php echo base_url();?>index.php/gardanband2_controller/gardanband2/"  target="_blank"  ><img src ="<?php echo base_url();?>/img/gardanband2.jpg" alt="گوشواره" class="part2img"></a>
		<a href="<?php echo base_url();?>index.php/gardanband3_controller/gardanband3/"  target="_blank"  ><img src ="<?php echo base_url();?>/img/gardanband3.jpg" alt="گوشواره" class="part2img"></a>
		<a href="<?php echo base_url();?>index.php/gardanband4_controller/gardanband4/"  target="_blank"  ><img src ="<?php echo base_url();?>/img/gardanband4.jpg" alt="گوشواره" class="part2img"></a>
		<a href="<?php echo base_url();?>index.php/gardanband5_controller/gardanband5/"  target="_blank"  ><img src ="<?php echo base_url();?>/img/gardanband5.jpg" alt="گوشواره" class="part2img"></a>
		<a href="<?php echo base_url();?>index.php/gardanband6_controller/gardanband6/"  target="_blank"  ><img src ="<?php echo base_url();?>/img/gardanband6.jpg" alt="گوشواره" class="part2img"></a>
	</div>
