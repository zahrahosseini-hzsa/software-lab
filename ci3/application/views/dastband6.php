...
<body>
	...
	<div class="container-fluid" id="part2">
		<section id="part2right">
			...
			<h3 class="part2h3">دستبند فیروزه اشک شوره ای </h3>
			<h4 class="part2h4">کد محصول:1060</h4>
			<p class="part2p">Turquoise-Bracelet</p>
			<p class="part2p">N: 6509</p>
			<p class="part2p">Ds:0.64 ct</p>
	
		
		</section>
		<section id="part2left">
			<img src="<?php echo base_url();?>img/dastband6.jpg" data-zoom-image="<?php echo base_url();?>img/dastband6.jpg" alt="pic" class="zoom z_img img-size">
		</section>
		
		<form action="<?php echo base_url();?>index.php/dastband6_controller/check_data/" method="post" class="col-lg-5 nazar">
            ...
            value="<a href='<?php echo base_url()?>index.php/dastband6_controller/dastband6/'> 1060 </a>" > 
            <input type="hidden" name="img" value="<img  src='<?php echo base_url();?>img/dastband6.jpg' width='150' />">
