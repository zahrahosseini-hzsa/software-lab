...
<body>
	...
	<div class="container-fluid" id="part2">
		...
		<form action="<?php echo base_url();?>index.php/nimset2_controller/check_data/" method="post" class="col-lg-5 nazar">
			...
			<input type="hidden" name="code" value="<a href='<?php echo base_url()?>index.php/nimset2_cntroller/nimset2/'> 1150 </a>">
			<input type="hidden" name="img" value="<img src='<?php echo base_url();?>img/nimset2.jpg' width='50' />">
