...
<body data-spy="scroll" data-target="#menu1"  >
	...
	<div class="container-fluid" id="part2">
		...
		<section class="part2section">
			<img src="img/stone.jpg" alt="news" class="part2img"  />
			...
			<a href="news2.html" target="_blank" class="part2a">ادامه مطلب</a>
		
		</section>
		
		<section class="part2section">
			<img src="img/birthstone.png" alt="news" class="part2img" >
			...
			<a href="news1.html" target="_blank" class="part2a">ادامه مطلب</a>
