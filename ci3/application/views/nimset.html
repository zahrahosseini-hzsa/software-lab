...
<title>نیم ست و سرویس</title>
	...
	<link rel="stylesheet" href="css/style_nimset.css">
...
<body data-spy="scroll" data-target="#menu1" >
			...
			<nav class="navbar navbar-expand-md navbar-dark fixed-top" id="menu1">
				...
				<div id="menu" class="collapse navbar-collapse col-lg-8 g">
					<ul class="navbar navbar-nav">
						...
						<li class="nav-item">
							<a href="#" class="nav-link">اخبار و مقالات</a>
						</li>
						<li class="nav-item dropdown">
	...
	<div class="container-fluid" id="part1">
		...
		<h4 class="h4"><a href="index.html" class="h4a">  جواهری</a>  )) محصولات  ))   نیم ست و سرویس  </h4>
	</div>
	...
	<div class="container-fluid" id ="part2">
		...
		<a href="nimset1.html"  target="_blank"  ><img src ="img/nimset1.jpg" alt="نیم ست و سرویس" class="part2img"></a>
		<a href="nimset2.html"  target="_blank"  ><img src ="img/nimset2.jpg" alt="نیم ست و سرویس" class="part2img"></a>
		<a href="nimset3.html"  target="_blank"  ><img src ="img/nimset3.jpg" alt="نیم ست و سرویس" class="part2img"></a>
		<a href="nimset4.html"  target="_blank"  ><img src ="img/nimset4.jpg" alt="نیم ست و سرویس" class="part2img"></a>
		<a href="nimset5.html"  target="_blank"  ><img src ="img/nimset5.jpg" alt="نیم ست و سرویس" class="part2img"></a>
		<a href="nimset6.html"  target="_blank"  ><img src ="img/nimset6.jpg" alt="نیم ست و سرویس" class="part2img"></a>
	</div>
